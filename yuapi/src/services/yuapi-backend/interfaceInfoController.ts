...
/** invokeInterfaceInfoNameGet POST /api/interfaceInfo/invoke/nameGet */
export async function invokeInterfaceInfoNameGetUsingPost(
  body: API.InterfaceInfoInvokeRequest,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponseObject_>('/api/interfaceInfo/invoke/nameGet', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** invokeInterfaceInfoWeatherGet POST /api/interfaceInfo/invoke/weather */
export async function invokeInterfaceInfoWeatherGetUsingPost(
  body: API.InterfaceInfoInvokeRequest,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponseObject_>('/api/interfaceInfo/invoke/weather', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
